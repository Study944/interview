...
import static com.zxc.interview.constant.UserConstant.USER_LOGIN_STATE;
...
import com.zxc.interview.constant.RedisConstant;
import com.zxc.interview.exception.BusinessException;
import com.zxc.interview.mapper.UserMapper;
...
import com.zxc.interview.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "zxc";
    ...
    public Boolean userSignIn(Long userId){
        ...
        String key = RedisConstant.getUserSignInKey(year, userId);
        // 获取当前日期对应的bitmap的偏移量
